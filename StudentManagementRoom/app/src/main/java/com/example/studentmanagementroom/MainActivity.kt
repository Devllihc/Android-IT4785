...
class MainActivity : AppCompatActivity() {
    ...
    private fun addSampleData() {
        val sampleStudents = listOf(
            Student(mssv = "SV001", hoten = "Nguyen Van A", ngaysinh = "2003-01-01", email = "a@example.com"),
            Student(mssv = "SV002", hoten = "Tran Thi B", ngaysinh = "2003-02-02", email = "b@example.com"),
            Student(mssv = "SV003", hoten = "Le Van C", ngaysinh = "2003-03-03", email = "c@example.com"),
        )
